          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-16 items-stretch">
              <LandingTariffCard 
                ...
                defaultCurrency="EUR"
                price="2 990"
                features={['Пополнение через СБП — 0₽', '3D Secure защита', 'Netflix, Spotify, ChatGPT и др.', 'Комиссия €0.25 за транзакцию']}
              />
              <LandingTariffCard 
                type="travel"
                name="Путешествия"
                defaultCurrency="USD"
                price="3 990"
                features={['Apple Pay / Google Pay', 'Работает в 190 странах', 'Пополнение через СБП — 0₽', 'Booking, Airbnb, Uber']}
                popular
              />
              <LandingTariffCard 
                type="premium"
                ...
                defaultCurrency="USD"
                price="14 990"
                features={['Лучший курс конвертации', 'Apple Pay / Google Pay', 'Приоритетная поддержка 24/7', 'Безлимитные операции']}
              />
            </div>
